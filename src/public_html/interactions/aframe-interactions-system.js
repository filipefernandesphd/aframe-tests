AFRAME.registerSystem('interactions', {
    schema: {
        raycaster: {type: "string"}
    },
    
    init: function(){
        if(this.detectDevice()){ // quando for celular
            this.mobileInteraction();
        }else{ // quando for computador
            this.desktopInteraction();
        }
    },
    ...
    mobileInteraction: function(){
        ...
        entity.setAttribute('raycaster', `objects: ${this.data.raycaster}`);
